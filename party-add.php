        ...
        <div class="page-header">
            ...
            <div class="am-page-upr-btn">
                <div class="left-btn">
                    ...
                    <div class="page-btn">
                        <a href="./party-list.php" class="btn btn-info"><i class="fa-solid fa-list-ul me-1"></i></i>Party List</a>
                    </div>
                </div>
                <div >
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="name" class="form-control" placeholder="Enter party name">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-12">
                                        <div class="mb-3">
                                            <label class="form-label" for="phn"> Phone Number<span class="text-danger ms-1">*</span></label>
                                            <input type="number" id="phn" class="form-control" placeholder="Enter phone number">
                                        </div>
                                    </div>
