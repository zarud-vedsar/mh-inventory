...
<div class="sidebar" id="sidebar">
	...
	<div class="sidebar-logo active">
		...
		<a id="toggle_btn" class="toggle_btn_side" href="#">
			...
			<ul>
				<li class="submenu-open">
					...
					<ul>
						...
						<li class="submenu">
							<a href="javascript:void(0);"><i class="ti ti-layout-grid fs-16 me-2"></i><span>Party
									Management</span><span class="menu-arrow"></span></a>
							<ul>
						...
						<li class="submenu">
							<a href="javascript:void(0);"><i class="ti ti-layout-grid fs-16 me-2"></i><span> Order
									Management</span><span class="menu-arrow"></span></a>
							<ul>
